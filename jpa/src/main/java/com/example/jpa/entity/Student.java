...
public class Student {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "student_seq_gen") // create sequence studenttbl_seq
    ...
    private String name; // name varchar2(255 char) null 허용
    ...
    @UpdateTimestamp // insert(초기화) + update(데이터 수정 할 때마다 그 시간이 자동으로 들어감)
